...
if (dataset == 'era5'):
	...
	times_to_use = ['00:00', '03:00', '06:00',
...
for var_to_use in var_lst:
	dir_out = base_dir + dataset + '/' + region + '/' + time_freq + '/' + var_to_use + '/' 
	print(dir_out)
	...
	for yr_to_use in yr_lst:
		print(yr_to_use)
		target_filename = dir_out + dataset + '-' + time_freq + '-' + region + '-' + var_to_use + '-' + yr_to_use + '.nc'
